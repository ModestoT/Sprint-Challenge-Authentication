...
1. What is the purpose of using _sessions_?
    ...
    Sessions are used to store information from a client to the server. 

1. What does bcrypt do to help us store passwords in a secure manner.

    It is a module that hashes passwords for us as well as allowing us to use an algorithm to hash it multiple times for extra security.  

1. What does bcrypt do to slow down attackers?

    It does accumulative hashing rounds making it take much longer for the attacker unless they know how many rounds the password was hashed.
